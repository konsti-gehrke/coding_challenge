...
public class Main {
    public static void main (String[] args) {
        ...
        Shop buecherDe = new Shop("buecher.de", new BigDecimal("0.0"), bookList1);
        Shop beckShop = new Shop("beck-shop.de", new BigDecimal("0.0"), bookList3);
        Shop thalia = new Shop("thalia.de", new BigDecimal("0.0"), bookList2);
        Shop thaliaCopy = new Shop("thaliacopy.de", new BigDecimal("0.0"), bookList5);
